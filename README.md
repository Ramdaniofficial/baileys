# Baileys - Typescript/Javascript WhatsApp Web API
 ...
 If you're interested in building a WhatsApp bot, you may wanna check out [WhatsAppInfoBot](https://github.com/Ramdaniofficial/WhatsappInfoBot) and an actual bot built with it, [Messcat](https://github.com/ashokatechmin/Messcat).
 
 **Read the docs [here](https://Ramdaniofficial.github.io/Baileys)**
 **Join the Discord [here](https://discord.gg/WeJM5FP9GG)**

## Example

Do check out & run [example.ts](https://github.com/Ramdaniofficial/Baileys/blob/master/Example/example.ts) to see example usage of the library.
...
```
yarn add @Ramdaniofficial/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:Ramdaniofficial/baileys
```

Then import in your code using:
``` ts 
// for multi-device
import makeWASocket from '@Ramdaniofficial/baileys'
// for legacy web
import {makeWALegacySocket} from '@Ramdaniofficial/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@Ramdaniofficial/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useSingleFileAuthState } from '@Ramdaniofficial/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@Ramdaniofficial/baileys'
...
import { AnyWASocket } from '@Ramdaniofficial/baileys'
```
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@Ramdaniofficial/baileys'
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/Ramdaniofficial/Baileys'}},
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@Ramdaniofficial/baileys'
                                */
...
import { downloadContentFromMessage } from '@Ramdaniofficial/baileys'
